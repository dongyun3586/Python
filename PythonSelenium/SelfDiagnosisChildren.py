...
# 학교급 선택하기 'elementary school'
driver.find_element_by_xpath('//*[@id="crseScCode"]/option[3]').click()         # 중학교 : //*[@id="crseScCode"]/option[4], elementary school: //*[@id="crseScCode"]/option[3]

# 학교명 입력하기
driver.find_element_by_xpath('//*[@id="orgname"]').send_keys('만호초등학교')      # 학교이름 입력 만호초등학교
# [검색(Search)] 버튼 클릭하기
driver.find_element_by_xpath('//*[@id="softBoardListLayer"]/div[2]/div[1]/table/tbody/tr[3]/td[2]/button').click()

time.sleep(1)

# 검색으로 생성된 [만호초등학교] 선택하기
...
# 이름 입력하기
driver.find_element_by_xpath('//*[@id="user_name_input"]').send_keys('이서준')  # 이름 입력

# 생년월일 입력하기
driver.find_element_by_xpath('//*[@id="birthday_input"]').send_keys('120911')   # 생년월일 입력
driver.find_element_by_xpath('//*[@id="birthday_input"]').send_keys(Keys.ENTER) # [Enter] 치기
time.sleep(1)

# 비밀번호(Password) 입력하기
driver.find_element_by_xpath('//*[@id="WriteInfoForm"]/table/tbody/tr/td/input').send_keys('1566')  # 이서준 1566
time.sleep(1)
driver.find_element_by_xpath('//*[@id="btnConfirm"]').send_keys(Keys.ENTER)     # [Enter] 치기
time.sleep(3)

kids_accounts = ['//*[@id="container"]/div/section[2]/div[2]/ul/li[1]/a/span[1]', '//*[@id="container"]/div/section[2]/div[2]/ul/li[2]/a/span[1]', '//*[@id="container"]/div/section[2]/div[2]/ul/li[3]/a/span[1]']

for i in range(len(kids_accounts)):
    # 사용자 계정의 버튼 클릭하기
    driver.find_element_by_xpath(kids_accounts[i]).click()
    time.sleep(3)
    ...
    # [처음으로] 버튼 클릭하기
    driver.find_element_by_xpath('/html/body/app-root/div/div[1]/div[1]/ul/li/a/span').click()
    time.sleep(3)
